...
const AppNavigator = () => (
  <NavigationContainer>
    <Stack.Navigator initialRouteName="Home">
      ...
      <Stack.Screen name="InterventionList" component={InterventionListScreen} options={{ headerShown: false }} />
      <Stack.Screen name="CreateIntervention" component={CreateInterventionScreen} options={{ headerShown: false }} />
      <Stack.Screen name="EditIntervention" component={EditInterventionScreen} options={{ headerShown: false }} />
    </Stack.Navigator>
  </NavigationContainer>
);
